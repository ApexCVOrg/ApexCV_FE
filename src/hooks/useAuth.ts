...
export const useAuth = (): UseAuthReturn => {
  ...
  const register = async (
    ...
    try {
      ...
      console.log('API URL:', `${process.env.NEXT_PUBLIC_API_URL || 'https://nidas-be-jnwz.onrender.com'}/auth/register`);
      console.log('Request Body:', JSON.stringify(requestData, null, 2));

      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://nidas-be-jnwz.onrender.com'}/auth/register`, {
        method: 'POST',
      ...
      console.error('API URL:', process.env.NEXT_PUBLIC_API_URL || 'https://nidas-be-jnwz.onrender.com');
      return {
        success: false,
