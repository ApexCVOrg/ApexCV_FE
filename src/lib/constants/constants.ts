...
export const ROUTES = {
  ...
  SHOES: {
    ...
    SL_72: '/shoes/sl-72',
    STAN_SMITH: '/shoes/stan-smith',
    LOW_PROFILE_COLLECTION: '/shoes/low-profile-collection',
    EVERY_DAY_RUNNING: '/shoes/every-day-running',
    RUN_ENERGISED: '/shoes/run-energised',
    RACE_TO_WIN: '/shoes/race-to-win',
