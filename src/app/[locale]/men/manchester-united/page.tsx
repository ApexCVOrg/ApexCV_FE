          ...
          {teams.map((team, idx) => (
            <Tab
              ...
              sx={{
                ...
                color: currentTeam === idx ? "#DA291C" : "inherit",
                textTransform: "none",
                minWidth: 120,
              }}
            />
