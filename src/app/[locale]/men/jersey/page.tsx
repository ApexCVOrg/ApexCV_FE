...
export default function MenJerseyPage() {
  ...
  return (
    <Box sx={{ bgcolor: "#f8f9fa", minHeight: "100vh", mt: 10, position: 'relative' }}>
      {/* Banner background with overlay - now below header, not fixed */}
      <Box sx={{ width: '100vw', height: 400, mx: 'calc(-50vw + 50%)', position: 'relative', overflow: 'hidden', zIndex: 1, display: 'flex', alignItems: 'center' }}>
        <img src="https://res.cloudinary.com/dqmb4e2et/image/upload/v1752517180/360_F_305556926_2QKGFHJ0AmtNsexJPjOgXVOOSUpy8g60_d6tt7m.jpg" alt="Men Jersey Banner" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', position: 'absolute', top: 0, left: 0, zIndex: 1 }} />
        ...
        <Box sx={{ position: 'relative', zIndex: 3, width: '100%', maxWidth: '1600px', mx: 'auto', px: { xs: 2, md: 6 } }}>
          <Box sx={{ pt: 4, pb: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, gap: 1 }}>
              ...
              <Typography component="span" sx={{ color: '#fff', mx: 0.5 }}>/</Typography>
              <Typography component="span" sx={{ color: '#fff', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: '4px', fontSize: '1rem' }}>Jersey</Typography>
            </Box>
