...
export default function WomenTrousersPage() {
    ...
    <div style={{ padding: 32 }}>
      <Box sx={{ px: { xs: 2, md: 6 }, pt: 4, pb: 2 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, gap: 1 }}>
          ...
          <Typography component="span" sx={{ color: 'grey.400', mx: 0.5 }}>/</Typography>
          <Typography component="span" sx={{ color: 'text.primary', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: '4px', fontSize: '1rem' }}>Trousers</Typography>
        </Box>
        ...
        <Typography variant="body1" sx={{ mt: 2, maxWidth: 900, color: 'text.secondary', fontSize: { xs: '1rem', md: '1.1rem' } }}>
          Thanh lịch và thoải mái với bộ sưu tập quần nữ, thiết kế đa dạng từ casual đến formal, phù hợp cho mọi dịp và phong cách.
        </Typography>
      </Box>
      ...
      {products.length === 0 && <p>Không có sản phẩm quần nào.</p>}
      <Box
        sx={{
          display: 'grid',
          gridTemplateColumns: {
