...
export default function WomenSportswearPage() {
    ...
    <div style={{ padding: 32 }}>
      <Box sx={{ px: { xs: 2, md: 6 }, pt: 4, pb: 2 }}>
        ...
        <Typography variant="body1" sx={{ mt: 2, maxWidth: 900, color: 'text.secondary', fontSize: { xs: '1rem', md: '1.1rem' } }}>
          Khám phá bộ sưu tập đồ thể thao nữ với thiết kế hiện đại, chất liệu cao cấp, phù hợp cho mọi hoạt động thể thao và thời trang hàng ngày.
        </Typography>
      </Box>
      ...
      {products.length === 0 && <p>Không có sản phẩm đồ thể thao nào.</p>}
      <Box
        sx={{
          display: 'grid',
          gridTemplateColumns: {
