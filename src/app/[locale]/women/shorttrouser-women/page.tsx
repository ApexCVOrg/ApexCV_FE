  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const sorted = sortProducts(shorts, sortBy);
        setProducts(sorted);
    ...
    <div style={{ padding: 32 }}>
      <Box sx={{ px: { xs: 2, md: 6 }, pt: 4, pb: 2 }}>
        ...
        <Typography variant="body1" sx={{ mt: 2, maxWidth: 900, color: 'text.secondary', fontSize: { xs: '1rem', md: '1.1rem' } }}>
          Thoải mái vận động với bộ sưu tập quần short nữ, chất liệu nhẹ, thoáng khí, phù hợp cho thể thao và mặc hàng ngày.
        </Typography>
      </Box>
