...
const spezialProducts = [
  {
    name: "Handball Spezial",
    price: "$120",
    image: "/assets/images/shoes/spezial/Giay_Handball_Spezial_mau_xanh_la_IG6192_01_standard.avif",
    rating: 4.8,
    reviews: 189
  },
  {
    name: "Spezial Classic",
    price: "$115",
    image: "/assets/images/shoes/spezial/Giay_Handball_Spezial_mau_xanh_la_IG6192_02_standard.avif",
    rating: 4.7,
    reviews: 156
  },
  {
    name: "Spezial Premium",
    price: "$130",
    image: "/assets/images/shoes/spezial/Giay_Handball_Spezial_mau_xanh_la_IG6192_03_standard.avif",
    rating: 4.9,
    reviews: 203
  }
];
          ...
          <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-start', alignItems: 'flex-end', pb: 2 }}>
            {TABS.map(tab => (
              <Link key={tab.value} href={`/shoes/${tab.value}`} style={{ textDecoration: 'none', flex: 1 }}>
                <Box sx={{
                  border: 0,
                  borderBottom: tab.value === 'spezial' ? '4px solid #000' : 'none',
                  bgcolor: tab.value === 'spezial' ? '#000' : '#fff',
                  color: tab.value === 'spezial' ? '#fff' : '#111',
                  fontWeight: tab.value === 'spezial' ? 700 : 500,
                  textAlign: 'center',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                  p: 0,
                  ...
                  '&:hover': {
                    ...
                    bgcolor: tab.value === 'spezial' ? '#000' : '#f5f5f5',
                    color: '#000',
                    fontWeight: 700,
                  ...
                  <Typography sx={{ py: 2, fontWeight: tab.value === 'spezial' ? 700 : 600, fontSize: '1.1rem', letterSpacing: 1, bgcolor: tab.value === 'spezial' ? '#000' : '#fff', color: tab.value === 'spezial' ? '#fff' : '#111', textTransform: 'uppercase' }}>{tab.label}</Typography>
                </Box>
              </Link>
            ))}
          </Box>
