...
export default function OrdersPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSnackbar({ open: true, message: ERROR_MESSAGES.MANAGER.INVALID_ORDER_DATA || "Failed to update order", severity: "error" });
        }
    };
    ...
    return (
        <Box sx={{ width: '100%', maxWidth: 1400, mx: 'auto', p: { xs: 1, md: 3 }, overflowX: 'auto' }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3, mb: 3, width: '100%', overflowX: 'auto' }}>
